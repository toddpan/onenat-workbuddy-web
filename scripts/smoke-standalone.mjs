...
async function main() {
  ...
  check('工具清单暴露 13 个工具', toolList.status === 200 && toolNames.length === 13 && toolNames.includes('workbuddy_project_manage') && toolNames.includes('workbuddy_task_ask_answer'), toolNames.join(','))
